...
export function SellerPanel({ initialUsers, products }: Props) {
  ...
  const handleLogin = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!nome) {
      setLoginError("Preencha o nome para entrar.");
      return;
    }
    ...
    if (!matchedUser) {
      setLoginError("Nome, senha ou tipo de acesso inválido.");
      return;
    }

    if (!isActiveUser(matchedUser)) {
      setLoginError("Conta desligada. Contacte o administrador para ativar o acesso.");
      return;
    }
